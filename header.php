    ...
    <nav class="container mx-auto px-6 py-4">
        ...
        <div class="lg:hidden hidden mt-4 pb-4 border-t border-surface" id="mobile-menu">
            <div class="flex flex-col space-y-4 mt-4">
                ...
                <a href="<?php echo esc_url( site_url('/experiences') ); ?>" class="text-text-secondary">Destinos</a>
               <!-- <a href="<?php echo esc_url( site_url('/guides') ); ?>" class="text-text-secondary">Guías</a> -->
                <a href="<?php echo esc_url( site_url('/pricing') ); ?>" class="text-text-secondary">Precios</a>
               <!-- <a href="<?php echo esc_url( site_url('/sustainability') ); ?>" class="text-text-secondary">Sostenibilidad</a> -->
                <a href="<?php echo esc_url( site_url('/about') ); ?>" class="text-text-secondary">Nosotros</a>
                <a href="<?php echo esc_url( site_url('/resenas') ); ?>" class="text-text-secondary">Reseñas</a>
                <a href="<?php echo esc_url( site_url('/experiences') ); ?>" 
