...
$planner_countries = [
    'indonesia' => [
        ...
        'image'       => $theme_uri . '/images/indonesia/viajes-a-indonesia-personalizados-bali.jpg',
        'hero_image'  => $theme_uri . '/images/destination-mood/viajes-personalizados-por-el-mundo-indonesia.jpg',
        'description' => 'Entre islas, cultura viva y naturaleza desbordante.',
    ],
    'colombia' => [
        'label'       => 'Colombia',
        'eyebrow'     => 'Caribe, montaña y ritmo propio',
        'image'       => $theme_uri . '/images/destination-mood/viajes-a-colombia-personalizados-cartagena-ciudad-amurallada.jpg',
        'hero_image'  => $theme_uri . '/images/destination-mood/viajes-personalizados-por-el-mundo-colombia.jpg',
        'description' => 'Un país diverso que pide rutas bien pensadas.',
    ],
    'costarica' => [
        'label'       => 'Costa Rica',
        'eyebrow'     => 'Selva, fauna y aventura consciente',
        'image'       => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-monteverde.jpg',
        'hero_image'  => $theme_uri . '/images/destination-mood/viajes-personalizados-por-el-mundo-costa-rica.jpg',
        'description' => 'Naturaleza intensa y momentos de conexión real.',
    ],
    'marruecos' => [
        'label'       => 'Marruecos',
        'eyebrow'     => 'Medinas, desierto y contraste',
        'image'       => $theme_uri . '/images/marruecos/viajes-personalizados-ukiyo-marruecos-merzouga.jpg',
        'hero_image'  => $theme_uri . '/images/destination-mood/viajes-personalizados-por-el-mundo-marruecos.jpg',
...
$travel_blocks = [
    'indonesia' => [
        [
            ...
            'image'   => $theme_uri . '/images/indonesia/viajes-a-indonesia-personalizados-bali-tirta-empul.jpg',
            'copy'    => 'Templos, arrozales y villas entre selva y mar.',
        ],
        [
            'name'    => 'Java',
            'tags'    => [ 'cultura', 'naturaleza', 'aventura' ],
            'image'   => $theme_uri . '/images/guides/viajes-a-indonesia-personalizados-monte-bromo.jpg',
        ...
        [
            ...
            'image'   => $theme_uri . '/images/indonesia/viajes-a-indonesia-personalizados-raja-ampat.jpg',
            'copy'    => 'Un remoto paraíso marino para viajes de gran impacto visual.',
        ],
        [
            'name'    => 'Borneo',
            'tags'    => [ 'naturaleza', 'fauna' ],
            'image'   => $theme_uri . '/images/indonesia/borneo/viajes-a-indonesia-borneo-25.jpg',
            'copy'    => 'Selva profunda y encuentros con fauna icónica.',
        ],
        [
            'name'    => 'Sulawesi',
            'tags'    => [ 'cultura', 'exploracion', 'especial' ],
            'image'   => $theme_uri . '/images/indonesia/viajes-autor-ukiyo-indonesiamanta.jpg',
    ...
    'colombia' => [
        ...
        [
            ...
            'image'   => $theme_uri . '/images/colombia/viajes-a-colombia-personalizados-eje-cafetero-valle-de-cocora.jpg',
            'copy'    => 'Paisaje verde, café y un ritmo suave entre montaña y finca.',
        ],
        [
            'name'    => 'Medellín',
            'tags'    => [ 'cultura', 'urbano' ],
            'image'   => $theme_uri . '/images/colombia/viajes-a-colombia-personalizados-medellin.jpg',
            'copy'    => 'Una ciudad viva, creativa y muy fácil de integrar en ruta.',
        ],
        [
            'name'    => 'Nuquí',
            'tags'    => [ 'naturaleza', 'aventura' ],
            'image'   => $theme_uri . '/images/colombia/viajes-a-colombia-personalizados-nuqui-ballena.jpg',
            'copy'    => 'Pacífico salvaje, selva, mar y sensación de desconexión total.',
        ],
        [
            'name'    => 'Tayrona',
            'tags'    => [ 'naturaleza', 'aventura' ],
            'image'   => $theme_uri . '/images/colombia/viajes-a-colombia-personalizados-tayrona.jpg',
            'copy'    => 'Costa Caribe, senderos y playas con carácter.',
        ],
        [
            'name'    => 'Santander',
            'tags'    => [ 'calma', 'naturaleza' ],
            'image'   => $theme_uri . '/images/colombia/viajes-a-colombia-personalizados-barichara.jpg',
            'copy'    => 'Pueblo colonial, senderos y una atmósfera muy especial.',
        ],
        [
            'name'    => 'Providencia',
            'tags'    => [ 'calma', 'especial' ],
            'image'   => $theme_uri . '/images/colombia/viajes-a-colombia-personalizados-providencia-mar-siete-colores.jpg',
    ...
    'costarica' => [
        ...
        [
            'name'    => 'Monteverde',
            'tags'    => [ 'naturaleza' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-monteverde-bosque-nuboso.jpg',
            'copy'    => 'Bosque nuboso, humedad, verde profundo y calma fresca.',
        ],
        [
            'name'    => 'Corcovado',
            'tags'    => [ 'aventura' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-osa-corcovado-hero.jpg',
            'copy'    => 'Uno de los tramos más salvajes para quien quiere intensidad natural.',
        ],
        [
            'name'    => 'Tortuguero',
            'tags'    => [ 'fauna' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-tortuguero-canales.jpg',
            'copy'    => 'Canales, agua, fauna y una sensación de aislamiento muy especial.',
        ],
        [
            'name'    => 'Puerto Viejo',
            'tags'    => [ 'calma', 'cultura' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-caribe-sur-cahuita.jpg',
            'copy'    => 'Caribe costarricense con mezcla cultural y mucho flow.',
        ],
        [
            'name'    => 'Rincón de la Vieja',
            'tags'    => [ 'aventura' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-guanacaste.jpg',
            'copy'    => 'Paisajes volcánicos secos, senderos y energía de aventura.',
        ],
        [
            'name'    => 'Sámara',
            'tags'    => [ 'calma' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-bahia-drake.jpg',
            'copy'    => 'Playa amable y una etapa muy equilibrada para soltar el ritmo.',
        ],
        [
            'name'    => 'Bajos del Toro',
            'tags'    => [ 'naturaleza', 'especial' ],
            'image'   => $theme_uri . '/images/costarica/viajes-a-costa-rica-personalizados-rio-celeste.jpg',
            'copy'    => 'Cascadas y verde intenso para un tramo distinto dentro del país.',
        ],
        [
            'name'    => 'San Gerardo de Dota',
            'tags'    => [ 'naturaleza', 'calma' ],
            'image'   => $theme_uri . '/images/viajesdeautor/wildcostarica/viajes-de-autor-a-costa-rica-fotografia-queztal.jpg',
    ...
    'marruecos' => [
        [
            ...
            'image'   => $theme_uri . '/images/marruecos/viajes-personalizados-ukiyo-marruecos-marrakech.jpg',
        ...
        [
            'name'    => 'Fez',
            'tags'    => [ 'cultura' ],
            'image'   => $theme_uri . '/images/marruecos/viajes-personalizados-ukiyo-marruecos-fez.jpg',
            'copy'    => 'Una ciudad profunda para quien quiere inmersión real.',
        ],
        [
            'name'    => 'Essaouira',
            'tags'    => [ 'calma' ],
            'image'   => $theme_uri . '/images/viajesdeautor/marruecos/viajes-de-autor-a-costa-rica-fotografia-costa.jpg',
            'copy'    => 'Costa atlántica, luz suave y un tempo mucho más ligero.',
        ],
        [
            'name'    => 'Tánger',
            'tags'    => [ 'cultura' ],
            'image'   => $theme_uri . '/images/viajesdeautor/marruecos/viajes-de-autor-a-costa-rica-fotografia-calle.jpg',
            'copy'    => 'Una ciudad puente entre continentes con mucha personalidad.',
        ],
        [
            'name'    => 'Meknes',
            'tags'    => [ 'cultura' ],
            'image'   => $theme_uri . '/images/marruecos/viajes-personalizados-ukiyo-marruecos-rissani.jpg',
            'copy'    => 'Una parada con historia para dar profundidad a la ruta.',
        ],
        [
            'name'    => 'Chefchaouen',
            'tags'    => [ 'especial' ],
            'image'   => $theme_uri . '/images/viajesdeautor/marruecos/viajes-de-autor-a-marruecos-azuljpg.jpg',
            'copy'    => 'La ciudad azul funciona muy bien como pausa inspiracional.',
        ],
        [
            'name'    => 'Rabat',
            'tags'    => [ 'cultura' ],
            'image'   => $theme_uri . '/images/viajesdeautor/marruecos/viajes-de-autor-a-costa-rica-fotografia-casablanca.jpg',
        ...
        [
            'name'    => 'Dades',
            'tags'    => [ 'naturaleza', 'aventura' ],
            'image'   => $theme_uri . '/images/marruecos/viajes-personalizados-ukiyo-marruecos-draa.jpg',
...
<section class="ukiyo-planner-hero relative flex items-center justify-center overflow-hidden pt-32 pb-16">
  <div class="absolute inset-0">
    <img
      src="<?php echo esc_url( $theme_uri . '/images/destination-mood/viajes-a-colombia-personalizados-cartagena-ciudad-amurallada.jpg' ); ?>"
