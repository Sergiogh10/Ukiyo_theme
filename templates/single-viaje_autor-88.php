        ...
        <div class="absolute bottom-0 left-0 right-0 p-6 lg:p-12">
            <div class="container mx-auto max-w-4xl">
                <div class="flex flex-wrap items-center gap-3 mb-6">
                    <span class="btn-primary text-text-secondary px-3 py-1 rounded-full text-sm font-medium">A medida</span>
...
<section class="py-20 bg-background">
  ...
  <section class="py-2 bg-background">
    <div class="container mx-auto">
      <nav class="trip-nav flex justify-center border-b border-surface bg-background backdrop-blur-sm py-4">
      ...
      <div class="flex w-full flex-col gap-4 overflow-hidden" data-accordion-new>
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            ...
            id="faq-btn-88-1" aria-expanded="false" aria-controls="faq-panel-88-1">
            <div>
          ...
          <div id="faq-panel-88-1" role="region" aria-hidden="true" aria-labelledby="faq-btn-88-1" 
            ...
            <div class="overflow-hidden">
              <p>Sí, la ruta se diseña únicamente para tu grupo y los traslados son exclusivos.</p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-88-2" aria-expanded="false" aria-controls="faq-panel-88-2">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-88-2" role="region" aria-hidden="true" aria-labelledby="faq-btn-88-2" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
              <p>Puedes ajustar noches, hoteles y excursiones antes de confirmar la reserva.</p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-88-3" aria-expanded="false" aria-controls="faq-panel-88-3">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-88-3" role="region" aria-hidden="true" aria-labelledby="faq-btn-88-3" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
              <p>Pasaporte vigente. Ciudadanos UE/Latam no necesitan visado para estancias turísticas menores a 90 días.</p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-88-4" aria-expanded="false" aria-controls="faq-panel-88-4">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
                <p class="w-full font-medium">¿Hay asistencia durante el viaje?</p>
              </div>
            </div>
            <div class="size-5">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div id="faq-panel-88-4" role="region" aria-hidden="true" aria-labelledby="faq-btn-88-4" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
              <p>Nuestro Travel Concierge está disponible por WhatsApp y teléfono 24/7 para cualquier imprevisto.</p>
            </div>
          </div>
        </div>
...
<section class="py-20 bg-background text-text-secondary text-center">
    <div class="container mx-auto px-6 max-w-3xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo esc_url( site_url('/planifica-tu-viaje') ); ?>" class="btn-primary text-text-secondary px-8 py-4 rounded-lg font-semibold hover:bg-accent-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/80 transition" aria-label="Abrir formulario para contarnos tu idea">
            Cuéntanos tu idea
            </a>
            <!-- <a href="<?php echo esc_url( site_url('/about') ); ?>" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-background hover:text-primary transition">Hablar con un Curador</a> -->
        </div>
    </div>
</section>
