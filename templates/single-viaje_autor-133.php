    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 md:p-6 lg:p-12">
      <div class="container mx-auto max-w-4xl">
        ...
        <div class="flex flex-wrap items-center gap-3 mb-6">
          <span class="btn-primary text-white px-3 py-1 rounded-full text-sm font-medium">6 días / 5 noches</span>
        ...
        <div class="hero-overlay-box">
          <h1 class="text-3xl md:text-4xl lg:text-6xl font-rowdies text-white mb-4 pl-4">
            Marruecos: <br>
            <span class="text-accent">Gran ruta de 6 días al desierto de Merzouga</span>
          </h1>

          <p class="text-xl text-white/90 max-w-3xl pl-4">
            “Una aventura completa de 6 días desde Marrakech. Descubre la magia de la Medina, cruza el Atlas, 
            explora la Ruta de las Mil Kasbahs y vive la inmensidad del Sahara en Merzouga.”
          </p>
  ...
  <div class="container mx-auto px-6">
    <header class="text-center max-w-3xl mx-auto mb-12">
      ...
      <p class="mt-4 text-lg text-text-secondary leading-relaxed">
        Este viaje de 6 días combina lo mejor de dos mundos: la vibrante vida de Marrakech con su historia y mercados, 
        y la paz absoluta del desierto del Sahara. Desde el bullicio de Jemaa El-Fna hasta el silencio de las dunas de Erg Chebbi, 
        pasando por gargantas milenarias y oasis verdes.
      </p>
    </header>
    ...
    <ul role="list" class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <li class="text-center bg-background backdrop-blur-sm rounded-2xl p-8 ring-1 ring-border/60">
        ...
        <p class="text-text-secondary">
          Recorre paisajes de película, cruzando el Valle de las Rosas, Skoura y visitando 
          las impresionantes Gargantas del Todra y Dades.
        </p>
      </li>
      ...
      <li class="text-center bg-background backdrop-blur-sm rounded-2xl p-8 ring-1 ring-border/60">
        ...
        <p class="text-text-secondary">
          Adéntrate en el desierto en dromedario para ver el atardecer y duerme en una jaima 
          bajo un cielo estrellado tras una cena tradicional bereber.
        </p>
      </li>
    ...
    <ol class="experienceList">
      ...
      <li class="experienceItemList">
        ...
        <h3 class="experienceTitle text-2xl font-rowdies text-text-primary mb-1">
          1. LLEGADA A MARRAKECH Y VISITA GUIADA
        ...
        <p class="mt-2 text-text-secondary max-w-xl">
          Recogida en el aeropuerto y traslado al Riad. Por la tarde, visita guiada por la Medina: 
          Plaza Jemaa El-Fna, Mezquita Koutoubia y zocos. Cena y alojamiento.
        </p>
        ...
        <div class="exp-content">
          <div class="experienceSplit">
            <div class="experienceSplit-text">
              <p>
                Salida cruzando el Alto Atlas por el puerto Tizi N’Tichka (2.260m).
                Continuamos por la Ruta de las Mil Kasbahs, pasando por el palmeral de Skoura y el Valle de las Rosas
                (famoso por su cultivo y artesanía de agua de rosas) hasta llegar a las Gargantas del Dades.
              </p>
            </div>
      ...
      <li class="experienceItemList">
        ...
        <div class="exp-content">
          <div class="experienceSplit">
            <div class="experienceSplit-text">
              <p>
                Visitamos las impresionantes Gargantas del Todra. Seguimos hacia Erfoud (fósiles) y Merzouga.
                Allí montaremos en dromedario para ver el atardecer en las dunas y llegar a nuestro campamento
                de jaimas. Cena tradicional, música bereber y noche bajo las estrellas.
              </p>
            </div>
            <figure class="experienceSplit-media">
              <img
      ...
      <li class="experienceItemList">
        ...
        <h3 class="experienceTitle accordion-trigger text-2xl font-rowdies text-text-primary mb-1">
          4. MERZOUGA · TAZZARINE · OUARZAZATE
          <span class="h3-subtitle">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/icon-nights.svg" alt="" />
            1 noche
          </span>
        ...
        <div class="exp-content">
          <div class="experienceSplit">
            <div class="experienceSplit-text">
              <p>
                Amanecer en las dunas y vuelta en dromedario. Desayuno y ducha.
                Salida hacia Ouarzazate pasando por Rissani (mercado tradicional), Alnif y Tazzarine,
                cruzando paisajes desérticos y el Valle del Draa.
                Llegada a Ouarzazate, el "Hollywood de África".
              </p>
            </div>
            <figure class="experienceSplit-media">
              <img
      ...
      <li class="experienceItemList">
        ...
        <div class="exp-content">
          <div class="experienceSplit">
            <div class="experienceSplit-text">
              <p>
                Visita a la Kasbah Taourirt y los estudios de cine. Parada en la espectacular Kasbah de Ait Ben Haddou
                (Patrimonio UNESCO). Almuerzo y cruce del Alto Atlas de regreso a Marrakech.
                Tarde libre para últimas compras o disfrutar del ambiente.
              </p>
            </div>
            <figure class="experienceSplit-media">
              <img
          ...
          <p class="text-text-primary mt-1">
            Alojamiento con desayuno. (Cena no incluida en Marrakech).
          </p>
        </div>
      </li>
      ...
      <li class="experienceItemList">
        ...
        <p class="mt-2 text-text-secondary max-w-xl">
          Desayuno en el riad y tiempo libre hasta la hora del traslado al aeropuerto de Marrakech.
        ...
        <div class="px-8">
          <ul class="space-y-2 text-center mb-4">
            ...
            <li class="flex justify-center">
              ...
              <span class="text-text-secondary">Transporte en vehículo 4x4 o minivan con A/C</span>
            </li>
            ...
            <li class="flex justify-center">
              ...
              <span class="text-text-secondary">Alojamiento en Hoteles/Riads y 1 noche en Jaima</span>
            </li>
            ...
            <li class="flex justify-center">
              ...
              <span class="text-text-secondary">Cenas y desayunos (excepto cenas en Marrakech)</span>
            </li>
             <li class="flex justify-center">
              <svg class="w-5 h-5 text-success mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
              </svg>
              <span class="text-text-secondary">Paseo en dromedario en Merzouga</span>
            </li>
        ...
        <div class="px-8">
          <ul class="space-y-2 text-center mb-4">
            ...
            <li class="flex justify-center">
              ...
              <span class="text-text-secondary">Cenas en Marrakech</span>
            </li>
      ...
      <div class="flex w-full flex-col gap-4 overflow-hidden" data-accordion-new>
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            ...
            id="faq-btn-133-1" aria-expanded="false" aria-controls="faq-panel-133-1">
            <div>
          ...
          <div id="faq-panel-133-1" role="region" aria-hidden="true" aria-labelledby="faq-btn-133-1" 
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-133-2" aria-expanded="false" aria-controls="faq-panel-133-2">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-133-2" role="region" aria-hidden="true" aria-labelledby="faq-btn-133-2" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-133-3" aria-expanded="false" aria-controls="faq-panel-133-3">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-133-3" role="region" aria-hidden="true" aria-labelledby="faq-btn-133-3" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-133-4" aria-expanded="false" aria-controls="faq-panel-133-4">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-133-4" role="region" aria-hidden="true" aria-labelledby="faq-btn-133-4" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-133-5" aria-expanded="false" aria-controls="faq-panel-133-5">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-133-5" role="region" aria-hidden="true" aria-labelledby="faq-btn-133-5" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
        ...
        <div class="flex flex-col items-start justify-start rounded-lg border border-slate-200 bg-background p-3 hover:cursor-pointer hover:bg-background">
          <button type="button" aria-disabled="false"
            class="group rounded-lg align-middle text-sm font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-slate-500 text-black min-w-[38px] gap-2 disabled:stroke-slate-400 disabled:text-slate-400 hover:opacity-80 flex h-auto w-full items-center justify-between overflow-hidden whitespace-pre-wrap p-0 text-left leading-tight"
            id="faq-btn-133-6" aria-expanded="false" aria-controls="faq-panel-133-6">
            <div>
              <div class="flex w-full items-center justify-start gap-2">
          ...
          <div id="faq-panel-133-6" role="region" aria-hidden="true" aria-labelledby="faq-btn-133-6" 
               class="grid w-full text-xs text-slate-600 md:pr-7 text-justify"
               style="grid-template-rows: 0fr; opacity: 0; transition: grid-template-rows 300ms ease-out, opacity 300ms ease-out;">
            <div class="overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center">
            <div class="max-w-3xl mx-auto">
              ...
              <p class="text-xl mb-8 opacity-90 reveal-on-scroll delay-100">
                    Seis días diseñados para sentir la inmensidad del Sahara, recorrer pueblos bereberes 
