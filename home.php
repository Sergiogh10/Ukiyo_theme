...
<style>
  ...
  .ukiyo-blog .featured__wrap{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(0,1fr);gap:4.5rem;align-items:center;max-width:1140px;width:100%;margin:0 auto}
