...
<style>
  ...
  .ukiyo-blog .featured__wrap{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:4.5rem;align-items:center;max-width:1140px;width:100%;margin:0 auto}
  .ukiyo-blog .featured__media{display:block;width:100%;min-width:0;position:relative;aspect-ratio:4/3;border-radius:24px;overflow:hidden;box-shadow:0 30px 70px -35px rgba(44,44,44,.4)}
  ...
  .ukiyo-blog .featured__copy h2{font-size:clamp(2.2rem, 4.2vw, 3.4rem);font-weight:400;letter-spacing:-0.02em;line-height:1.05;margin-bottom:1.2rem;color:var(--ink);overflow-wrap:break-word;hyphens:auto}
